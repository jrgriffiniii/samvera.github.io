...
Basic metadata properties are defined in [app/models/concerns/hyrax/basic_metadata.rb](https://github.com/samvera/hyrax/blob/v2.1.0.rc2/app/models/concerns/hyrax/basic_metadata.rb)
...
Core metadata properties (**_that should never be removed_**) are defined in [app/models/concerns/hyrax/core_metadata.rb](https://github.com/samvera/hyrax/blob/v2.1.0.rc2/app/models/concerns/hyrax/core_metadata.rb)
...
```ruby
  # "http://lib.my.edu/departments" is a made up predicate.  Recommended that you replace with an appropriate pre-existing predicate 
